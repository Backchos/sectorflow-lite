...
# -*- coding: utf-8 -*-
"""
SectorFlow Lite - 파일 기반 주식 분석 도구
인터넷 연결 없이 로컬 파일로만 분석
"""
...
def main():
    """메인 함수"""
    print("🚀 SectorFlow Lite - 파일 기반 분석 도구")
    print("=" * 50)
    ...
    # 분석할 종목 선택
    print("\n🔍 분석할 종목을 선택하세요:")
    print("1. KOSPI 상위 30개 전체")
    print("2. 개별 종목 선택")
    print("3. 사용 가능한 모든 종목")
    ...
    if choice == "1":
        ...
        analysis_name = "KOSPI_상위30개"
    elif choice == "2":
        # 개별 종목 선택
        print(f"\n사용 가능한 종목: {', '.join(available_symbols)}")
        symbol_input = input("종목코드를 입력하세요 (쉼표로 구분): ").strip()
    ...
    chart_path = f"analysis_chart_{analysis_name}_{timestamp}.png"
    create_chart(stock_data, f"{analysis_name} 분석 결과", chart_path)
    
    # HTML 결과 저장
    html_path = f"analysis_result_{analysis_name}_{timestamp}.html"
